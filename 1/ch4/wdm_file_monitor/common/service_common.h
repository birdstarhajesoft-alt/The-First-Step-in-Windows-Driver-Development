...
#define MYDRIVER_SERVICENAME            L"WDM_FILE_MONITOR"
#define MYDRIVER_SERVICEDISPLAYNAME     L"WDM_FILE_MONITOR Driver"
#define MYDRIVER_FILENAME               L"\\WDM_FILE_MONITOR.SYS"
