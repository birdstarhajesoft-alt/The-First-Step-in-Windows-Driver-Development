...
#define MYDRIVER_SERVICENAME            L"WDM_INTERRUPTBASED"
#define MYDRIVER_SERVICEDISPLAYNAME     L"WDM_INTERRUPTBASED Driver"
#define MYDRIVER_FILENAME               L"\\WDM_INTERRUPTBASED.SYS"
