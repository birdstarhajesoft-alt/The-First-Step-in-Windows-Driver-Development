...
#define MYDRIVER_SERVICENAME            L"WDM_POLLINGBASED"
#define MYDRIVER_SERVICEDISPLAYNAME     L"WDM_POLLINGBASED Driver"
#define MYDRIVER_FILENAME               L"\\WDM_POLLINGBASED.SYS"
