...
#define MYDRIVER_SERVICENAME            L"WDM_IRP_MESSAGING"
#define MYDRIVER_SERVICEDISPLAYNAME     L"WDM_IRP_MESSAGING Driver"
#define MYDRIVER_FILENAME               L"\\WDM_IRP_MESSAGING.SYS"
