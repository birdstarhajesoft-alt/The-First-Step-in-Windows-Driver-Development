...
#define MYDRIVER_SERVICENAME            L"WDM_BAN_TERMINATE"
#define MYDRIVER_SERVICEDISPLAYNAME     L"WDM_BAN_TERMINATE Driver"
#define MYDRIVER_FILENAME               L"\\WDM_BAN_TERMINATE.SYS"
